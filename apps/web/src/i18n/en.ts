export const en = {
  ...
  profile: {
    ...
    settings: {
      ...
      dangerZone: {
        title: "Danger zone",
        hint: "Irreversible account actions.",
        deleteAccount: "Delete account",
        deleteAccountHint: "Your account, list, comments and achievements will be permanently deleted. This can't be undone.",
        dialogTitle: "Are you absolutely sure?",
        dialogBody: "This will permanently delete your account \"{name}\" — list, comments, achievements, watch progress, all of it. To continue, type the phrase below and your password.",
