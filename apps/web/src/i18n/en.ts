export const en = {
  ...
  admin: {
    ...
    overview: {
      ...
      pageviews30d: "Pageviews (30d)",
      uniqueVisitors: "Unique visitors (7d)",
      watchCard: "Watch activity",
      totalWatchTime: "Total watch time",
      sessions: "Watch sessions",
      topReferrers: "Where users come from",
      direct: "Direct",
      topPaths: "Top pages",
      topAnime: "Most watched",
      noData: "No data yet.",
    },
    users: {
      searchPlaceholder: "Search by name or email…",
      columns: { user: "User", joined: "Joined", telegram: "Telegram", role: "Admin", banned: "Banned" },
      emptyTitle: "No one found.",
    },
    comments: {
      searchPlaceholder: "Search comment text…",
      columns: { author: "Author", anime: "Anime", body: "Text", date: "Date" },
      deleted: "Deleted",
    ...
    reviews: {
      ...
      columns: { author: "Author", anime: "Anime", rating: "Rating", body: "Text", date: "Date" },
