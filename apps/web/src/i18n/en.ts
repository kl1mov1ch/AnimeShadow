export const en = {
  ...
  recommendations: {
    ...
    lead: "Heart the titles you like — the home rail and each title's \"you might like\" row will start leaning on their genres. The more you mark, the sharper it gets.",
    searchPlaceholder: "Find an anime to mark…",
    searchResults: "Search results",
    likedHeading: "Liked ({count})",
    likedEmpty: "Nothing yet — search above or pick from the popular titles below.",
