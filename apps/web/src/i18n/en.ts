export const en = {
  ...
  watch: {
    ...
    stalledHint: "This player is taking too long — pick another track below.",
    stable: "stable",
    unstable: "unstable",
  ...
  profile: {
    ...
    settings: {
      ...
      showcaseHint: "Pick one of your earned achievements to show next to your name in your profile and comments.",
  ...
  home: {
    ...
    popularWeekSub: "What everyone's watching right now",
